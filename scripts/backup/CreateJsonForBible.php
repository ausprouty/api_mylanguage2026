...
function csvToStructuredJson($filePath, $outputDir)
{
    ...
    while (($row = fgetcsv($file, 0, '|')) !== false) {
        ...
        if (!empty($hlCode)) {
            $outputFile = rtrim($outputDir, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . $hlCode . DIRECTORY_SEPARATOR . 'bibleStructured.json';
...
$filePath = 'data/NewBibleStructureData.txt';
